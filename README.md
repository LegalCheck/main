...
1. Clone the application with `git clone git@github.com:LegalCheck/main.git`.
2. `cd` into the folder: `cd main`.
3. Install the node modules (you must have node installed on your system): `npm install` (or `yarn install` if running yarn).
